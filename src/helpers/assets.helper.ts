...
const Assets: any = {
  ...
  clearIcon: ClearIcon,
  nyCalculatorIcon: NyCalculatorIcon,
  repriceIcon: RepriceIcon,
  denyAllIcon: DenyAllIcon,
  importBillsIcon: ImportBillsIcon,
  generateEOBOrDOCIcon: GenerateEOBOrDOCIcon,
